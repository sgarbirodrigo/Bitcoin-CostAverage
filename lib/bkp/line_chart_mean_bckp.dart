...
/*
  ...
  LineChartData sampleData2() {
    ...
    if (price_spots.length > 0) {
      print(
          "price_spot_last:${Timestamp.fromMillisecondsSinceEpoch(price_spots.first.x.toInt() * 1000).toDate()}");
    }
    ...
    return LineChartData(
      ...
      titlesData: FlTitlesData(
        ...
        leftTitles: SideTitles(
          interval: avgPrice == 0 ? 1 : avgPrice * 0.05,
          showTitles: false,
          getTextStyles: (value) => const TextStyle(
            color: Color(0xff75729e),
            fontWeight: FontWeight.bold,
  ...
  double min=0, max=1, xmin, xmax, avgPrice = 0, totalExpended = 0, denominador = 0;
/*
