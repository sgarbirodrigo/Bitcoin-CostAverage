    ...
    return Column(
      ...
      children: [
        ...
        Container(
            ...
            //height: 300,
            child: widget.user.userData.orders.length>0?ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  print("test${widget.user.userData.orders.values.toList()[index]}");
                  PairData _pairData = widget
                      .user.pairDataItems[widget.user.userData.orders.values.toList()[index].pair];
                          ...
                          Container(
                            ...
                            child: Column(
                              ...
                              children: [
                                ...
                                WeekIndicator(
                                    widget.user.userData.orders.values.toList()[index].schedule,
                                    order_status)
                              ],
                            ),
                          ),
                ...
                }):Container(child: Center(child: Text("Here you will be able to view all the orders that are being executed daily."),),)),
      ],
    );
  }
}
