...
class OrdersRightColumnWidget extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Container(
      width: 130,
      child: Obx(() {
        if (historyController.pairData_items
          ...
          return Column(
            ...
            children: [
              Padding(
                ...
                child: Text(
                  getAppreciationConverted(historyController.pairAppreciation[
              ...
              Padding(
                ...
                child: Text(
                  '+${returnCurrencyCorrectedNumber(userController.user.orders.values.toList()[this.index].pair.split("/")[0], historyController.pairData_items.value[userController.user.orders.values.toList()[this.index].pair].coinAccumulated)}',
